...
describe('REGISTRATION PAGE 2 (NEGATIVE)', () => {
    beforeEach(() => {
        RegisterStep2Page.open();
    });

    it('TC-127 should Phone Number field can not accept incorrect number (min number) of digits and an error message display', () => {
    ...
    it('TC-128 should Phone Number field can not accept incorrect number (max numbers) of digits and an error message display', () => {
    ...
    it('TC-129 should Phone Number field can not accept symbols and an error message display', () => {
    ...
    it('TC-130 should Phone Number field can not accept Upper letters and an error message display', () => {
    ...
    it('TC-131 should Phone Number field can not accept Lower letters and an error message display', () => {
    ...
    it('TC-132 should Phone Number field can not accept "Back space" and an error message display', () => {
    ...
    it('TC-133 should Phone Number field can not be empty', () => {
