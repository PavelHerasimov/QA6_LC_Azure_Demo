...
describe('UPDATE PASSWORD', () => {
  ...
  describe('TC-044 UPDATE PASSWORD FROM SETTINGS NEGATIVE TESTING', () => {
    beforeEach(() => {
      browser.refresh();
    });

    it('TC-045 a pop-up with an error message should appears after entering wrong old password  ', () => {
    ...
    it('TC-046 the "Update Password" button is disabled when "Old password" field is not filled ', () => {
    ...
    it('TC-047 the "Update Password" button is disabled when "Confirm new password" field is not filled ', () => {
      SettingsPasswordPage.oldPasswordInput.addValue(passwordSettingsNegative.oldCorrectPassword);
      SettingsPasswordPage.newPasswordInput.addValue(passwordSettingsNegative.newPassword);
      expect(SettingsPasswordPage.updatePasswordButton.isEnabled().false);
    });

    it('TC-048 the "Update Password" button is disabled when "New password" field is not filled ', () => {
      SettingsPasswordPage.oldPasswordInput.addValue(passwordSettingsNegative.oldCorrectPassword);
      SettingsPasswordPage.confirmNewPasswordInput.addValue(passwordSettingsNegative.newPassword);
      expect(SettingsPasswordPage.updatePasswordButton.isEnabled().false);
    });

    it('TC-049 an error message should appears  when new password mismatch with confirm new password ', () => {
      SettingsPasswordPage.updatePasswordNegative(
        passwordSettingsNegative.oldWrongPassword,
        passwordSettingsNegative.newPassword,
    ...
    it('TC-050 a pop-up with an error message should appears when new password contains only four symbols', () => {
      SettingsPasswordPage.updatePasswordNegative(
