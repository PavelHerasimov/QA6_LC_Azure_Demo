...
describe('PROFILE (FUNCTIONAL) IN SETTINGS', () => {
  before(() => {
    LoginPage.open();
  ...
  it('first name input field should accept " A " ', () => {
  ...
  it('first name input field should accept " aaaaaaaaaaaaaaaaaa " ', () => {
    clearValue(settingProfilePage.firstNameIF);
  ...
  it('first name input field should accept " a\'sssa- " ', () => {
    clearValue(settingProfilePage.firstNameIF);
  ...
  it('last name input field should accept " A " ', () => {
  ...
  it('last name input field should accept " aaaaaaaaaaaaaaaaaa " ', () => {
    clearValue(settingProfilePage.lastNameIF);
  ...
  it('last name input field should accept " a\'sssa- " ', () => {
    clearValue(settingProfilePage.lastNameIF);
  ...
  it('phone input field should accept 11 numbers " 11111111111 " ', () => {
  ...
  it('phone input field should accept 12 numbers " 111111111111 " ', () => {
    clearValue(settingProfilePage.phoneIF);
  ...
  it('user should be able to update About field with 50 random letters and spaces', () => {
  ...
  it('user should be able to update My Goal field with 50 random letters and spaces', () => {
  ...
  it('user should be able to change the country using DDL', () => {
  ...
  it('user should be able to change level of english using DDL', () => {
  ...
  it('user should be able to change t-shirt size using DDL', () => {
