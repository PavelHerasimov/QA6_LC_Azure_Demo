...
describe('LOGOUT FUNCTIONALITY', () => {
  ...
  it('TC-052 should verify that NEW USER can logout to Login Page', () => {
  ...
  it('TC-051 should verify that ADMIN can logout to Login Page', () => {
  ...
  it('TC-053 should verify that LEARNER can logout to Login Page', () => {
  ...
  it('TC-054 should verify that STUDENT can logout to Login Page', () => {
