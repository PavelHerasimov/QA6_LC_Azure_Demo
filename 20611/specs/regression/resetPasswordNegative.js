...
describe('Reset Password Negative ', () => {
  ...
  it('TC-032 Email input requires "@" and "." are required ', () => {
  ...
  it('TC-033 "Required" will appear under "Reset Password" field', () => {
  ...
  it('TC-036 Send password reset link button is disabled until the Email field has valid data', () => {
