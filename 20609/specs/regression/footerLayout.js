...
describe('FOOTER', () => {
  ...
  it('TC-103 Verify that footer text is correct', () => {
    expect(FooterPage.footer.getText()).equal(textFooterPage.headerFooter);
  });

  it('TC-104 Verify that "contact us" link is clickable', () => {
    expect(FooterPage.contactUs.isClickable()).true;
  });

  it('TC-105 Verify that "Terms of Service" link is clickable', () => {
    expect(FooterPage.termsOfService.isClickable()).true;
  });

  it('TC-106 Verify that "Privacy Policy" link is clickable', () => {
    expect(FooterPage.privacyPolicy.isClickable()).true;
  });

  it('TC-107 Verify that redirect to "contact us" page is correct', () => {
    FooterPage.navToContactUs();
    expect(ContactUsPage.headerContactUs.getText()).equal(textFooterPage.contactUsHeader);
  });

  it('TC-108 Verify that redirect to "Terms of service" page is correct', () => {
  ...
  it('TC-109 Verify that redirect to "Privacy Policy" page is correct', () => {
