...
describe('SMOKE LOGIN PAGE TEST', () => {
  ...
  describe('TC-01-031 LOGIN ADMIN', () => {
    it('should Successful log in as an Admin ', () => {
  ...
  describe('TC-01-032 LOGIN NEW USER', () => {
    it('should Successful log in as an New ', () => {
  ...
  describe('TC-01-033 LOGIN LEARNER', () => {
    it('should Successful log in as an Learner ', () => {
  ...
  describe('TC-01-034 LOGIN STUDENT', () => {
    it('should Successful log in as an Student ', () => {
