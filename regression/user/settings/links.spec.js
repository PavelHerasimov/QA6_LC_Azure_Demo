...
describe('TC-005 LINKS TAB ELEMENTS ACCEPT CORRECT INPUT AND SAVE CHANGES', () => {
  ...
  it('#14 Links Facebook Input accepts and saves data', () => {
  ...
  it('#15 Links LinkedIn Input accepts and saves data', () => {
  ...
  it('#16 Links GitHub Input accepts and saves data', () => {
  ...
  it('#17 Links Codewars Input accepts and saves data', () => {
