...
describe('Pop-up drawer', () => {
  it('TC-008-047 Verify that if user clicks "Skip", log-out, log-in - pop-up drawer shows-up', () => {
  ...
  it('TC-008-048 Verify that if user clicks "Skip", log-out, log-in - pop-up drawer title is displayed ', () => {
    RegisterStep2Page.skipBtn.click();
    ProfilePage.logout();
    LoginPage.login(user.email, user.password);
  ...
  it('TC-008-049 Verify that if user clicks "Skip", log-out, log-in - pop-up drawer title text is "Contact information"', () => {
    RegisterStep2Page.skipBtn.click();
    ProfilePage.logout();
    LoginPage.login(user.email, user.password);
  ...
  it('TC-008-050 Verify that if user clicks "Skip", log-out, log-in - close icon (x) is displayed', () => {
    RegisterStep2Page.skipBtn.click();
    ProfilePage.logout();
    LoginPage.login(user.email, user.password);
  ...
  it('TC-008-051 Verify that if user clicks "Skip", log-out, log-in and clicks close icon (x) drawer closes', () => {
    RegisterStep2Page.skipBtn.click();
    ProfilePage.logout();
    LoginPage.login(user.email, user.password);
  ...
  it('TC-008-052 Verify that if user clicks "Skip", log-out, log-in and clicks "Skip" link drawer closes', () => {
    ProfilePage.logout();
    LoginPage.login(user.email, user.password);
    RegisterStep2Page.skipBtn.click();
    expect(ProfilePage.headerProfile.getText()).eq(user.firstName + ' ' + user.lastName);
  ...
  it('TC-008-053 Verify that if user clicks "Skip", log-out, log-in and enters valid information (country, phone) drawer doesnt show up again', () => {
    ProfilePage.logout();
    LoginPage.login(user.email, user.password);
